...
export default function HomePage() {
  return (
    ...
    <section className="min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4">
      ...
      <p className="text-lg lg:text-3xl maw-w-screen-xl">Optimize your product pricing across countries to maximize sales.
    ...
    <section className="bg-primary text-primary-foreground">
      <div className="container py-16 flex flex-col gap-16 px-8 md:px-16 ">
        <h2 className="text-3xl text-center text-balance">
          Trust by the top modern comanies 
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-16">
          <Link href="https://neon.teck">
            <NeonIcon />
          </Link>
          <Link href="https://clerk.teck">
            <ClerkIcon />
          </Link>
          <Link href="https://neon.teck">
            <NeonIcon />
          ...
          <Link className="md:max-xl:hidden" href="https://clerk.teck">
            <ClerkIcon />
          </Link>
        </div>
      </div>  
    </section>
    <section id="Pricing" className="px-8 py-16 bg-accent/">
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {formatCompactNumber(maxNumberOfVisits)} pricing page visite/mo
        </CardDescription>
      </CardHeader>
      <CardContent>
        <SignUpButton>
